namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        {
            var details = (Car)this.GetModel(() => this.controller.Details(0));
        ...
        [TestMethod]
        public void DetailShouldWorkCorrectlyIfValidId()
        {
            var details = (Car)this.GetModel(() => this.controller.Details(1));
        ...
        public void SortShouldThrowArgumentExceptionIfEmptyInput()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void SortShouldThrowArgumentExceptionIfWrongInput()
        {
            var sortedCars = (ICollection<Car>)this.GetModel(() => this.controller.Sort("id"));
        }

        [TestMethod]
        public void SortByMakeShouldWorkCorrectlyIfCorrectInput()
        {
        ...
        [TestMethod]
        public void SortByYearShouldWorkCorrectlyIfCorrectInput()
        {
        ...
        [TestMethod]
        public void SearchEmptyStringShouldReturnEmptyList()
        {
            var searchCars = (ICollection<Car>)this.GetModel(() => this.controller.Search(string.Empty));

            Assert.AreEqual(0, searchCars.Count);
        }

        [TestMethod]
        public void SearchWrongInputShouldReturnEmptyList()
        {
            var searchCars = (ICollection<Car>)this.GetModel(() => this.controller.Search("databases"));
